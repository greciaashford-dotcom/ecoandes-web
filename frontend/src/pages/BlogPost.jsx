  ...
  return (
    <article className="bg-bone-100" data-testid="blog-post-page">
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-12">
        <img src={post.cover} alt={post.title} className="w-full aspect-[16/9] object-cover rounded-2xl shadow-[0_18px_50px_rgba(45,51,47,0.10)]" />
      </div>
          ...
          {recommendations.map((p) => (
            <Link key={p.slug} to={`/blog/${p.slug}`} className="group">
              <div className="aspect-[4/3] overflow-hidden bg-bone-200 rounded-2xl">
                <img src={p.cover} alt={p.title} className="w-full h-full object-cover group-hover:scale-[1.06] transition-transform duration-700" loading="lazy" />
              </div>
